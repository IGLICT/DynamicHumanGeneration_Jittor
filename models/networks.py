    ...
    def get_target_tensor(self, input, target_is_real):
        ...
        if target_is_real:
            ...
            if create_label:
                ...
                self.real_label_var = jt.zeros(input.size(), dtype=jt.float32).stop_grad() + self.real_label
            ...
            if create_label:
                ...
                self.fake_label_var = jt.zeros(input.size(), dtype=jt.float32).stop_grad() + self.fake_label
...
class GlobalGenerator(nn.Module):
    def __init__(self, input_nc, output_nc, ngf=64, n_downsampling=3, n_blocks=9, norm_layer=nn.BatchNorm2d, 
        ...
        for i in range(n_downsampling):
            ...
            model += [nn.ConvTranspose(ngf * mult, int(ngf * mult / 2), kernel_size=3, stride=2, padding=1, output_padding=1),
...
class Vgg19(jt.nn.Module):
    def __init__(self, requires_grad=False):
        ...
        vgg_model_path = '../../DanceDataset/vgg19-dcbb9e9d.pth'
        ...
        # else:
        vgg_pretrained_features = vgg_jittor.vgg19(pretrained=True).features
